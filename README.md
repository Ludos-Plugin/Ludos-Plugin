...
De cet engouement découle une popularité grandissante pour certains modes de jeu, tels que le Manhunt, un mode de jeu créé et popularisé via YouTube.
...
## Objectif
Notre projet a pour vocation de rendre accessible le mode de jeu Manhunt sur Minecraft à l'aide d'un plugin pour l'implémenté dans le futur sur un serveur.
