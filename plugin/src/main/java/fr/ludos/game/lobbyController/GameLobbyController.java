...
public class GameLobbyController extends GameProcessBase {
	...
	private final LobbyStartDelayOption waitDurationOption;
	public final LobbyStartDelayOption getWaitDurationOption() {
		return waitDurationOption;
	}

	protected GameLobbyController(Game game, LobbyWaitPlayersOption waitPlayersOption, LobbyStartDelayOption waitDurationOption) {
		if (game == null) {
		...
		this.waitDurationOption = waitDurationOption;
	}
