...
public enum BurrowerShovelLevels implements Level<BurrowerShovelLevels> {
	...
	private BurrowerShovelLevels(Material material, double xpThreshold, Map<Enchantment, Integer> enchantments) {
	...
	@Override
	public Class<BurrowerShovelLevels> getLevelClass() {
		return BurrowerShovelLevels.class;
	}
