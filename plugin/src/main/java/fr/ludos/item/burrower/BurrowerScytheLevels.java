...
public enum BurrowerScytheLevels implements Level<BurrowerScytheLevels> {
	...
	private BurrowerScytheLevels(Material material, double xpThreshold, Map<Enchantment, Integer> enchantments) {
	...
	@Override
	public Class<BurrowerScytheLevels> getLevelClass() {
		return BurrowerScytheLevels.class;
	}
