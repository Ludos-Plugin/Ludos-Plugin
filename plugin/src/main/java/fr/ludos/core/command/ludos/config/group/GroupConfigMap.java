...
public final class GroupConfigMap extends ConfigNodeMap {
	public static final EnumConfigEntry<GroupRightsOption> MEMBERS_AUTH =
		new EnumConfigEntry<>("Members authorisation", "member_authorisation", GroupRightsOption.class, GroupRightsOption.invite);

	public static final EnumConfigEntry<GroupJoinOption> GROUP_JOIN =
		new EnumConfigEntry<>("Group join behaviour", "group_join", GroupJoinOption.class, GroupJoinOption.manual_accept);

	public static final EnumConfigEntry<GameJoinOption> GAME_JOIN =
		new EnumConfigEntry<>("Member Game join behaviour", "game_join", GameJoinOption.class, GameJoinOption.auto);

	public static final EnumConfigEntry<LobbyWaitPlayersOption> WAIT_PLAYERS =
		new EnumConfigEntry<>("Players to wait in lobby", "wait_players", LobbyWaitPlayersOption.class, LobbyWaitPlayersOption.all);

	public static final IntegerConfigEntry START_DELAY =
		new IntegerConfigEntry("Lobby start delay seconds", "start_delay", 10, Set.of(5, 10, 30), true);
