...
/**
 * {@link AccessAuthorization} implementation to authorize access to a Group's config ({@link Group#getConfig()}).
 */
public class GroupConfigAuthz implements AccessAuthorization {
	private final GroupManager manager;

	public GroupConfigAuthz(GroupManager manager) {
